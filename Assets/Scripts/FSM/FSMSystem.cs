...
namespace FSM
{
    ...
    public enum Transition
    {
        ...
        PlayMenuTransition = 1,
        MenuPlayTransition = 2,
        PlayGameOverTransition = 3,
        GameOverPlayTransition = 4,
        GameOverMenuTransition = 5
    ...
    public abstract class FSMState
    {
        ...
        public void AddTransition(Transition trans, StateID id)
        {
            ...
            {
                Debug.LogError($"FSMState ERROR: State {stateID} already has transition {trans} Impossible to assign to another state");
                return;
            }
        ...
        public void DeleteTransition(Transition trans)
        {
            ...
            Debug.LogError($"FSMState ERROR: Transition {trans} passed to {stateID} was not on the state's transition list");
        }
        ...
        /// <summary>
        /// This method is used to make anything necessary, as resetting variables
